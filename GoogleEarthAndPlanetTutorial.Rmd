...
* GPS coordinates
    + download the [GPS track for KBay sandbar](https://www.dropbox.com/s/tu15mw2723mle5c/GPSTrack_KBaySandbar_FieldSiteExploration_2021_05.gpx?dl=0) (Annie's field site exploration!)
...
* Timelapse (for visualization of change)
    + In Google Chrome (not Safari), open [Google Earth web's Timelapse feature](https://earth.google.com/web/@44.69848065,58.8251508,132a,821204d,35y,-1h,54t,0r/data=CjISMBIgNTQ0MGExNzMxYzI1MTFlYTk0NDM4YmI2ODk0NDUyOTciDG1haW5Ob1JhbmRvbQ)
    ...
    + In the *right hand* (not left hand) search bar, type "Palm Jumeirah" and watch the coastline
